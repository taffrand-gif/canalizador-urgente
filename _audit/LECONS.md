# LECON## Leçon #413 (19/07 2026) — E-E-A-T organisationnel : le brief reste soumis au grep SOT
...
## Leçon #432 (19/07 2026) — Tranche MD 21-25 : rangs 21-25 PLOMBERIE du MD-CORPUS-TRIAGE sont déjà ÉPUISÉS au moment de la mission
...
5. **Le `tel:` href = CONSTANTE canonique E.164** définie dans `AGENTS.md` §NAP, **JAMAIS** le pattern parasite `tel:+351****XXXX` recopié depuis un fichier HTML/TSX (le parasite est l'inverse du masquage mémoire — leçon #142). Toujours repartir d'`AGENTS.md` §NAP.
...
## Leçon #430 (19/07 2026) — Hubs→villages : matcher le plus long préfixe puis réconcilier 1:1
