...
- **`r145-zero-delay-sweep`** : jamais de délai chiffré type « 24h/7 dias » sans validation explicite Philippe ; « resposta mediante confirmação por telefone » / « atendimento prioritário » = BANNIS. Conforme AGENTS.md §11.
...
- 🟡 **Autres R145 résiduels** flaggés par sub-agent P3 (hors scope) : `Atendimento prioritário`, `equipa de piquete`, `orçamento grátis`, `desde X€`, `Experiência profissional`, délais chiffrés — batch 2 à programmer.
...
| 1 | `"Diagnóstico por telefone em poucos minutos — ligue 928 484 451, atenção dedicada após contacto telefónico ao telefone. Tempo conforme zona e disponibilidade da equipa."` |
