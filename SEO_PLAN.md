...
**Prochaine action** : **A4 = étendre Doctrine §12 aux 1203 autres pages HTML du site canalizador-urgente** (pages locales courtes `canalizador-{ville}.html` hors périmètre services) OU équivalent eletricista-urgente (1863 fichiers).
