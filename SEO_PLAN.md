...
- **Modifs** : title/meta description/H1/direct-answer/JSON-LD BlogPosting alignés sur `canalizador urgente` ; prix issus de `PRICING.md` (65 €/h, Z1=15 €, Z2=25 €, Z3=35 €, Z4=45 €, Z5=55 €, Z6=65 €, +50 %) ; sitemap-blog.xml active 29, URL passée de commentaire post-merge à URL indexable lastmod 2026-08-05 priority 0.7.
- **Conformité** : R11 zéro invention ; R12 transparence prix + phrase `orçamento por escrito antes de qualquer intervenção, sem surpresas` + `fala sempre com a mesma pessoa, não um call center` ; R145 aucun délai chiffré ; §14 CU = 0 DGEG/TRIESP/wallbox/carregador dans la page.
- **PR** : draft à créer sur branche `feat/cu-rankpush-canalizador-urgente-t_ee3a8eee`, base `main`, zéro merge sans GO Filipe (R7). Mesure GSC J+7 via `gsc-trajectoire-cron.sh`.
