...
| T1-MONEY | Aligner H1 + sub homepage sur query money 'canalizador urgente' (CPC=14.63 EUR, vol=170, score=2487.10 — DFSEO 16/07) | HAUTE | ⏸ DRAFT | [#334](https://github.com/taffrand-gif/canalizador-urgente/pull/334) | GO Filipe (R7) | `canalizador[\s-]?urgente` (H1 l.252 + sub l.253) ; occurrences homepage 4 → 6 (+50 %) ; témoins R8 cf. JOURNAL.md (zone `t_be736a00`) |
<!-- CHANTIERS:END -->
