...
**Dernière MAJ** : 2026-09-21 — **PR #337 DRAFT** (T2-MONEY-WEAK `canalizador urgente` homepage reinforcement : FAQPage JSON-LD + section 'Situações' 385 mots + 6 liens internes /zonas/, branche `fix/cu-t2-money-weak-canalizador-urgente-t_3a35e691` commit `5a7dce57c` + commit `8b96006cb` R145 fix + meta OG/Twitter/keywords + title 112→93 car). Suite logique de PR #335 CLOSED (T1-MONEY H1+sub) — vague 2 money broad money 'canalizador urgente' (CPC=14.63 EUR, score=2487.10). R7 STOP MERGE : attente GO Filipe. Dette close : FAQPage JSON-LD (SEO_PLAN l.128). R145 fix in-place : 'menos de duas horas' → 'indicamos a janela de chegada antes de sair' (1→0 délai chiffré). Mesure J+7/J+14 via gsc-trajectoire-cron.sh, baseline 2026-09-21 = 3 impr / 0 clic / pos 14.3, cible top 10 SERP. **Hotspot pré-existant (hors-scope) signalé** : `public/index.html` l.323-324 dit "Filipe atende" + "é ele quem faz/chega/emite" + "fala comigo" — viole Annexe A pronom collectif. Prédat commit f2000345e8 (PR #152, 30/06/2026, R12 equipa batch). À traiter dans X-R12 vague PME-solo séparée, **PAS** dans scope T2-MONEY-WEAK.
