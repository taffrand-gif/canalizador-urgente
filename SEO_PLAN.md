...
| T2-MONEY-WEAK | Renforcer homepage (WEAK sur 3 impr / 0 clic / pos 14.3 — même query broad money 'canalizador urgente') : +FAQPage JSON-LD 5 questions (close dette SEO_PLAN l.128), +section 'Situações que pedem um canalizador urgente' 385 mots visibles 6 cas typiques equipment réel, +6 liens internes /zonas/ (Bragança/Mirandela/Chaves/Macedo/Vila Real/Lamego — homepage avait 0 lien sortant) | HAUTE | ⏸ DRAFT | [#337](https://github.com/taffrand-gif/canalizador-urgente/pull/337) | GO Filipe (R7) | branche `fix/cu-t2-money-weak-canalizador-urgente-t_3a35e691` ; commit `5a7dce57c` ; homepage 438→478 lignes / 1895→2340 mots (+445 fichiers, +385 visible) ; FAQPage JSON-LD absent→présent ; /zonas/ liens 0→6 ; H1+sub INCHANGES (PR #335) ; Doctrine §12 65€/h×5 Z×21 +50%×3 orçamento×3 NAP×13 Ridgid×2 ROLeak×2 FLIR×1 INTACTS |
<!-- CHANTIERS:END -->
...
**Dernière MAJ** : 2026-09-21 — **PR #337 DRAFT** (T2-MONEY-WEAK `canalizador urgente` homepage reinforcement : FAQPage JSON-LD + section 'Situações' 385 mots + 6 liens internes /zonas/, branche `fix/cu-t2-money-weak-canalizador-urgente-t_3a35e691` commit `5a7dce57c`). Suite logique de PR #335 CLOSED (T1-MONEY H1+sub) — vague 2 money broad money 'canalizador urgente' (CPC=14.63 EUR, score=2487.10). R7 STOP MERGE : attente GO Filipe. Dette close : FAQPage JSON-LD (SEO_PLAN l.128). Mesure J+7/J+14 via gsc-trajectoire-cron.sh, baseline 2026-09-21 = 3 impr / 0 clic / pos 14.3, cible top 10 SERP.
