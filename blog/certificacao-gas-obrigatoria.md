---
title: "Certificação Gás Obrigatória: Guia Completo 2026"
slug: "certificacao-gas-obrigatoria"
...
**Vai instalar esquentador? Fez obras na cozinha? Vai vender casa?** A certificação de instalações de gás é **obrigatória por lei** em múltiplas situações. Sem certificado, arrisca multas €500-€44,890, problemas na venda/arrendamento e, mais grave, riscos de segurança. Neste guia completo, explicamos quando é obrigatória, o que inclui, custos e como obter rapidamente.

## 📋 O Que É Certificação Gás?

### Definição

**Certificação gás** = Documento oficial que atesta que instalação de gás cumpre normas de segurança

**Regulamenta**:
- Instalação tubagem gás
- Ligação aparelhos (esquentador, fogão, caldeira)
- Ventilação adequada
- Válvulas segurança
- Conformidade normas técnicas

**Legislação**: Decreto-Lei 521/99 + Portaria 361/2000
...
**Distribuidor gás** (Galp, Repsol):
- Fornece gás após certificação
...
✅ **Instalação nova** (casa nova, primeira instalação)
✅ **Alteração instalação** (mudar esquentador local, adicionar aparelho)
✅ **Substituir aparelho gás** (esquentador, caldeira, fogão)
✅ **Obras cozinha/casa banho** (se afeta instalação gás)
...
- Pressuriza sistema
- Verifica perda pressão
- Localiza fugas (se existirem)
- **Obrigatório**

**Teste combustão**:
- Analisa gases queima
- Verifica eficiência
- Deteta monóxido carbono (CO)
- **Obrigatório esquentador/caldeira**

**Teste ventilação**:
- Verifica tiragem chaminé
- Mede caudal ar
- **Obrigatório**
...
**Certificado inclui**:
- Termo Responsabilidade Instalação (TRI)
- Esquema instalação
...
## 💰 Custos Certificação Gás 2026

### Habitação (Apartamento/Moradia)
...
**Esquentador** (instalação + certificação):
- Tubagem (10-15m): €200-400
- Esquentador: €200-600
- Instalação: €150-300
- Certificação: €150-250
- **Total**: €700-1550

**Caldeira** (instalação + certificação):
- Tubagem: €300-600
- Caldeira: €1500-3000
- Instalação: €300-600
- Certificação: €250-400
- **Total**: €2350-4600

### Custos Adicionais (Se Necessário)

**Correções não conformidades**:
- Ventilação inadequada: €100-300
- Tubagem incorreta: €150-500
- Válvulas em falta: €50-150

**Reinspeção** (se chumbou):
- €80-120
...
- Conformidade normas
- Necessidade correções
- Orçamento

### Passo 3: Correções (Se Necessário) (1-3 dias)

**Exemplos comuns**:
- Instalar grelha ventilação
- Adicionar válvula corte
- Corrigir tubagem
- Melhorar ventilação
...
### Passo 5: Emissão Certificado (2-5 dias)

**Documentação**:
- TRI (Termo Responsabilidade Instalação)
- Esquemas técnicos
- Resultados testes
- Recomendações
...
✅ Caderneta predial
✅ Planta habitação (se disponível)
✅ Fatura compra aparelhos gás

### Recebe Após Certificação

✅ Certificado gás (original)
✅ TRI (Termo Responsabilidade Instalação)
✅ Esquema instalação
✅ Relatório testes
✅ Manual utilização/manutenção
...
**Reincidência**: Multas duplicam

### Problemas Venda/Arrendamento

❌ Notário pode recusar escritura
❌ Banco pode recusar financiamento
❌ Comprador pode desistir
❌ Valor imóvel reduz 5-10%

### Problemas Distribuidor

❌ Galp/Repsol recusam ligar gás
❌ Cortam gás se detetarem irregularidade
❌ Não reativam sem certificado

### Riscos Segurança

❌ Fugas gás (explosão)
❌ Intoxicação CO (monóxido carbono - fatal)
❌ Incêndio
❌ Seguro pode não cobrir (instalação irregular)

## 🏠 Certificação Gás em Trás-os-Montes

### Desafios Específicos

**Casas Antigas**:
- Maioria sem certificação
- Instalações 30-50 anos
- Ventilação inadequada
- Tubagem antiga (ferro)

**Gás Propano** (botijas):
- Comum em zonas rurais
- Também precisa certificação (instalação fixa)
- Botijas móveis: não precisa

**Inverno Rigoroso**:
- Esquentador/caldeira essenciais
- Uso intenso
- Segurança crítica
...
**Disponibilidade Trás-os-Montes**:
- Bragança: sim (centro)
- Mirandela: sim (centro)
- Zonas rurais: não

### Gás Propano (Botijas)

**Vantagens**:
- Disponível em todo lado
- Sem mensalidade
- Flexível

**Certificação**:
- **Instalação fixa**: obrigatória
- **Botijas móveis**: não precisa
...
✅ Instalou esquentador novo
✅ Fez obras cozinha
✅ Vai vender/arrendar
✅ Quer certificar por segurança
...
### Emergência Gás (Imediato)

✅ Cheiro gás
✅ Fuga visível
✅ Suspeita problema grave

**Ação**: Feche gás, abra janelas, evacue, ligue 112 + técnico
...
- 10+ anos experiência
- 300+ certificações gás
- Todas as marcas aparelhos
...
**Sim** para: instalação nova, alteração, substituir aparelho, venda/arrendamento (pós-1999), reativação gás.

### Quanto custa certificação gás?
...
### Posso vender casa sem certificação gás?
...
**Precisa certificação gás? Orçamento grátis Atendemos 24h/7 dias, mediante confirmação por telefone.**
