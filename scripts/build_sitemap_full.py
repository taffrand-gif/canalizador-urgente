...
def build_sitemap_xml(urls_with_relpath):
    ...
    `urls_with_relpath` est une liste de tuples (url, priority, relPath)
    ou `relPath` designe le fichier .html a utiliser pour git_lastmod().
    """
...
def main():
    ...
    # Construction ordonnee (avec relPath pour calcul lastmod honnete).
    entries = []
